// This is a namespace. If you aren't familiar they are a neat way of organising code.
//It has many benifits such as being useful at keeping reuseable code together and hiding parts of your code base unless they are declared with the "using" keyword.
// This is what UnityEngine is and other usings. More on this next lesson.
namespace GeorgeProject
{
    ...
    public class PlayerStats : MonoBehaviour
    {
        ...
        [SerializeField]
        float moveSpeed, jumpHeight, lookSensitivityX, lookSensitivityY, minimumAngle, maximumAngle;
